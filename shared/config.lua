...
Config.PaymentAccount = 'money'                                 --cash : bank : black_money : money
...
Config.SellerPeds = {
    {
        ...
        coords = vector4(-52.295391, -212.457214, 44.805763, 160.685959),
        --jobs = {},
        scenario = "WORLD_HUMAN_CLIPBOARD",
        dropOffVehicle = "mule",                                    --Vehicle the player needs to drop off the items in
        dropOffVehicleSpawn = vector4(-70.674988, -212.153381, 45.444965, 157.200623), --Point where the vehicle spawns
    },
